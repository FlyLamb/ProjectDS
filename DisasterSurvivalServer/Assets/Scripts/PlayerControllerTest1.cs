/*
    ...
    WARNING:
    If you change the player's height, you'll have to manually configure the `normalCheckerHeigh`, as it's not adjusted yet. To get the value, place the player somewhere and run the game. When the player
    falls and touches ground, right click the script and select [Get Normal Checker Height]
