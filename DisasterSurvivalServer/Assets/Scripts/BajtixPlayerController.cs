...
// STUPID ASS WAY OF DOING IT! THERE SOULD BE A LOOP HERE OR SOMETHIN... 
    ...
    void Start() {
        ...
        GetComponent<CapsuleCollider>().material = new PhysicMaterial("Player body") {dynamicFriction = 0, staticFriction = 0, frictionCombine = PhysicMaterialCombine.Minimum};
    ...
    void FixedUpdate() {
        ...
        Motors(input.x,input.y);
        var jump = input.z > 0.5f;
